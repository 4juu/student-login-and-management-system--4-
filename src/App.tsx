...
function App() {
  ...
  // إجراءات CRUD — مُستخرجة إلى useDataActions (كانت 19 useCallback مبعثرة هنا)
  const {
    handleAddCollege, handleDeleteCollege,
    handleAddStage, handleDeleteStage,
    handleAddStudent, handleAddMultipleStudents, handleUpdateStudent,
    handleDeleteStudent, handleDeleteSelectedStudents,
    handleSortByName, handleSortByGroup,
    handleAttendanceRecord, handleClearRecords, handleUpdateRecord, handleDeleteRecord,
    handleCreateSession, handleSelectSession, handleRenameSession, handleDeleteSession,
  } = useDataActions({
    stages,
    currentUser,
    confirmAction,
